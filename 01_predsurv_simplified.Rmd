...
# COMMENT: I will wait for brier function of Terry
score_rdata1 <-
...
rownames(res_ov) <- c("", "Brier", "Scaled Brier")
res_ov
```
...
temp <- c(Uno_C_rdata$concordance,
...
cmat  <- matrix(temp, nrow=3, byrow=TRUE,
               dimnames=list(c("Apparent","Apparent + PGR" ,"GBSG", "Validate GBSG"),
                             c("Harrell", "Uno")))
round(cmat,3)
