...
# Scaled Brier / IPA confidence intervals
...
cmat  <- matrix(temp, nrow=2, byrow=TRUE,
...
cmat <- round(cmat, 2) # Digit
res_C_lab <- rep(c("Estimate", "Lower .95 ", "Upper .95"), 4)
res_C <- rbind(res_C_lab,cmat)
rownames(res_C) <- c("", "Harrell C", "Uno C")
