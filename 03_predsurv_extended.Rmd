...
NOTE: add brief comments about concordance
...
int_summary[1] + c(-1.96, 0, 1.96)* int_summary[2]

slope_summary <- summary(pfit2)$coefficients
slope_summary_pgr <- summary(pfit2_pgr)$coefficients
slope_summary[2, 1] + c(-1.96, 0, 1.96)* slope_summary[2, 2]
slope_summary_pgr[2, 1] + c(-1.96, 0, 1.96)* slope_summary_pgr[2, 2]
