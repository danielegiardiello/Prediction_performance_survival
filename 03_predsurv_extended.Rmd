...
More detailed explanations are available in the preprint version of the  [paper](https://www.medrxiv.org/content/10.1101/2022.03.17.22272411v1).
...
<details>
  <summary>Click to expand code</summary>
```{r, cal_rcs_metrics, fig.align='center', fig.width = 6, fig.height = 6, echo=TRUE, eval=FALSE}
# Models  ---
efit1 <- coxph(Surv(ryear, rfs) ~ csize + nodes2 + nodes3 + grade3,
  data = rott5, x = T, y = T
)
...
<details>
  <summary>Click to expand code</summary>
```{r, cumhaz_plot, message=FALSE,warning=FALSE, fig.align='center', fig.width = 6, fig.height = 6, echo=TRUE, eval=FALSE}
...
```{r, cumhaz_plot, fig.align='center', fig.width = 6, fig.height = 6, warning=FALSE, eval=TRUE}
```
