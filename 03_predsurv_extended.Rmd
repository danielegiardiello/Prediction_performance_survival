...
UnoC_boot1<-function(split) {Uno_C(
...
UnoC_boot1b<-function(split) {Uno_C(
  tfup=analysis(split)$ryear,
  status=analysis(split)$status, 
...
eboot <- eboot %>% mutate(UnoC1=map_dbl(splits,UnoC_boot1),
                          UnoC1b=map_dbl(splits,UnoC_boot1b))
# saveRDS(eboot,'eboot.rds')
vboot <-vboot %>% mutate(UnoC1=map_dbl(splits,UnoC_boot1),
                         UnoC1b=map_dbl(splits,UnoC_boot1b))
