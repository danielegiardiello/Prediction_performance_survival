...
<details>
  <summary>Click to expand code</summary>
```{r, surv, fig.align='center', fig.width = 6, fig.height = 6, echo=TRUE, eval=FALSE}
# Development set
...
```{r, surv, fig.align='center', warning=FALSE, eval=TRUE, fig.width = 6, fig.height = 6}
```
...
options(datadist = "dd")
options(prType = "html")
fit_cph_rott5 <- cph(Surv(ryear, rfs) ~ csize + 
